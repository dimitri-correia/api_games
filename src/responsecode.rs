...
pub enum ResponseCode {
    ...
    InsufficientQuantity478, // 478: Insufficient quantity of this item in your inventory / in the bank.
}
...
impl ResponseCode {
    pub fn get_code(&self) -> u16 {
        match self {
            ...
            ResponseCode::FullInventory497 => 497,
